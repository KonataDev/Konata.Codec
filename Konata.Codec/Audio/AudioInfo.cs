...
public readonly struct AudioInfo
{
    ...
    public AudioInfo(AudioFormat format,
        AudioChannel channels, int sampleRate)
    {
        Format = format;
        Channels = channels;
    ...
    public static AudioInfo Default()
        => new AudioInfo(AudioFormat.Signed16Bit, AudioChannel.Stereo, 44100);
    
    /// <summary>
    /// Default mp3 presets
    /// </summary>
    /// <returns></returns>
    public static AudioInfo Mp3()
        => new AudioInfo(AudioFormat.Signed16Bit, AudioChannel.Stereo, 44100);
    ...
    /// </summary>
    /// <returns></returns>
    public static AudioInfo SilkV3()
